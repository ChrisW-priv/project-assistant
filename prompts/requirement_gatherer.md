...
5. Turn the project idea into actionable user stories
...
{Business Requirements (formatted as user stories, each line is bullet point with a user story)}

## Extra information (optional, do not include if not necessary)
{Optional information that the user deemed necessary, like a data of release or benefit value etc.}
```
...
Save the final initiative proposal file as `initiative_proposal.md`.
